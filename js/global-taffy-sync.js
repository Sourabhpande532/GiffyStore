...
/*  
-TAFFY DB IT's in Memory Database & IT's sync file
-Provided by Javascript
-Whatever data we create inside TAFFY DB
-We'r going to sync it through from localStorage thats is data 
 percietance tool that is Provided by default from Browser
 Whatever Data we crate in TAffy DB this is all Provided here 
 we'll add this initial data it to our Database data 
 @NOTE: syncing it to a localStorage so that that data you'r add it
 should percietance even if you refresh or reload your page it should 
 not go away:
 we make sure to all those think here so that no data will go away in this file */
